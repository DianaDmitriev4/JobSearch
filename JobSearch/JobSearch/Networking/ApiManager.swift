...
final class ApiManager {
    static func getVacancies(completion: @escaping (Result<[VacanciesModel], Error>) -> Void) {
   ...
   static private func handleResponse(data: Data?, error: Error?, completion: @escaping (Result<[VacanciesModel], Error>) -> Void) {
        if let error {
